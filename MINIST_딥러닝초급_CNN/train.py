...
from mnist_classification.models import FullyConnectedClassifier
from mnist_classification.models import ConvolutionalClassifier
...
def define_argparser():
    ...
    p.add_argument('--model', type = int, default = 'fc')
